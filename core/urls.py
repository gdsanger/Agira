...
urlpatterns = [
    ...
    path('projects/<int:id>/members/add/', views.project_add_member, name='project-add-member'),
    path('projects/<int:id>/members/remove/', views.project_remove_member, name='project-remove-member'),
    ...
    path('items/<int:item_id>/field/', views.item_update_field, name='item-update-field'),
    ...
    path('open-questions/<int:question_id>/answer/edit/', views.item_open_question_answer_edit, name='item-open-question-answer-edit'),
    path('open-questions/<int:question_id>/answer/delete/', views.item_open_question_answer_delete, name='item-open-question-answer-delete'),
    ...
    path('changes/<int:id>/print-user-report/', views.change_print_user_report, name='change-print-user-report'),
    ...
    path('changes/<int:id>/send-update-reminder/', views.change_send_update_reminder, name='change-send-update-reminder'),
    path('changes/<int:id>/send-update-completed/', views.change_send_update_completed, name='change-send-update-completed'),
    ...
    path('organisations/<int:id>/users/create/', views.organisation_create_user, name='organisation-create-user'),
